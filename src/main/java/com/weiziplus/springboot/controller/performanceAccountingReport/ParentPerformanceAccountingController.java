...
@Api(value="ParentPerformanceAccountingController",tags={"业绩核算父体"})
@RestController
//@ApiIgnore
@AdminAuthToken
@RequestMapping("/pc/performanceAccountingReport/parentPerformanceAccounting")
public class ParentPerformanceAccountingController {
	@Autowired
