...
//@ApiIgnore
@AdminAuthToken
@RequestMapping("/pc/logisticsDelivery/shopDeliveryDetails")
public class ShopDeliveryDetailsController {
	...
	public ResultUtil getPageList(
        ...
        return service.getShopDeliveryDetailsPageList(pageNum, pageSize,shop,area);
    }
}
