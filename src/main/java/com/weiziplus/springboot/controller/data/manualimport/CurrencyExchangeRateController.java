...
import com.weiziplus.springboot.service.data.manualimport.CurrencyExchangeRateService;
 ...
 * @data 2019/7/19 9:34
 */
@Api(value="CurrencyExchangeRateController",tags={"货币汇率(手动导入)"})
@RestController
//@ApiIgnore
@AdminAuthToken
@RequestMapping("/pc/data/manualImport/currencyExchangeRate")
public class CurrencyExchangeRateController {
    ...
    @PostMapping("/add")
    public ResultUtil add( @ApiParam(value = "货币汇率", required = true)CurrencyExchangeRate currencyExchangeRate) {
        return service.add(currencyExchangeRate);
    }
    ...
    @PostMapping("/update")
    public ResultUtil update( @ApiParam(value = "货币汇率", required = true)CurrencyExchangeRate currencyExchangeRate) {
        return service.update(currencyExchangeRate);
    }
