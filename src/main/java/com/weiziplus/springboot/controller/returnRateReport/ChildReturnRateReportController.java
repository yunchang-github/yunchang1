...
@Api(value="ChildReturnRateReportController",tags={"退货率报告子体数据"})
@RestController
//@ApiIgnore
@AdminAuthToken
@RequestMapping("/pc/returnRateReport/childReturnRateReport")
public class ChildReturnRateReportController {
	@Autowired
