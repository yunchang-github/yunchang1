            ...
            public int compare(Object a, Object b) {
                ...
                try {
                    ...
                    if (type == int.class) {
                        ...
                        ret = (Double.valueOf(String.valueOf(f.get(a)))).compareTo(Double.valueOf(String.valueOf(f.get(b))));
                    } else if (type == long.class) {
                        ret = ((Long) f.getLong(a)).compareTo((Long) f
                                .getLong(b));
                    } else if (type == Long.class) {
                        ret = (Long.valueOf(String.valueOf(f.get(a)))).compareTo(Long.valueOf(String.valueOf(f.get(b))));
                    } else if (type == float.class) {
                        ret = ((Float) f.getFloat(a)).compareTo((Float) f
                                .getFloat(b));
                    }
                    else if (type == Integer.class) {
                        ret = ((Integer) f.get(a)).compareTo((Integer) f.get(b));
                    } else if (type == Float.class) {
                        ret = ((Float) f.get(a)).compareTo((Float) f.get(b));
                    }
                    else if (type == Date.class) {
                    } else if (type == Float.class) {
                        ret = (Float.valueOf(String.valueOf(f.get(a)))).compareTo(Float.valueOf(String.valueOf(f.get(b))));
                    } else if (type == Date.class) {
