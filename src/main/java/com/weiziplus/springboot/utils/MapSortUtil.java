...
public class MapSortUtil {
     ...
     * 按Float类型值升序排列
     */
    public static Map<String, Float> sortByFloatValueAsc(Map<String, Float> originMap) {
        if (originMap == null) {
            return null;
        }
        return sort(originMap, comparatorByValueAsc);
     ...
     * 按Float类型值降序排列
     */
    public static Map<String, Float> sortByFloatValueDesc(Map<String, Float> originMap) {
        if (originMap == null) {
            return null;
        }
        return sort(originMap, comparatorByValueDesc);
     ...
     * 按Integer值升序排列
     */
    public static Map<String, Integer> sortByIntegerValueAsc(Map<String, Integer> originMap) {
        if (originMap == null) {
            return null;
        }
        return sort(originMap, comparatorByValueAsc);
     ...
     * 按Integer值降序排列
     */
    public static Map<String, Integer> sortByIntegerValueDesc(Map<String, Integer> originMap) {
        if (originMap == null) {
            return null;
        }
        return sort(originMap, comparatorByValueDesc);
