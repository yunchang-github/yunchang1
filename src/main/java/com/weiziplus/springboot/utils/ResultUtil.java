...
public class ResultUtil implements Serializable {
     ...
     * 默认密码
     */
    private static final Integer ERROR_DETAIL_PASSWORD = 402;
     ...
     * 用户没有权限
     */
    private static final Integer ERROR_ROLE_CODE = 406;
    ...
    public static ResultUtil errorDetailPassword(String msg, Object data) {
        return content(ERROR_DETAIL_PASSWORD, msg, data);
    }

    public static ResultUtil errorDetailPassword() {
        return content(ERROR_DETAIL_PASSWORD, "初次登录,请先修改密码", null);
    }
    ...
    public static ResultUtil errorRole(String msg) {
