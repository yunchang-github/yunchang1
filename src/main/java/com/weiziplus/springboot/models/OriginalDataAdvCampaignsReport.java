...
/**
 * original_data_adv_campaigns_report
 * @author Administrator
 * @date 2019-11-13 13:09:05
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@Data
@Table("original_data_adv_campaigns_report")
public class OriginalDataAdvCampaignsReport implements Serializable {
    /**
     */
    @Id("id")
    private Long id;
