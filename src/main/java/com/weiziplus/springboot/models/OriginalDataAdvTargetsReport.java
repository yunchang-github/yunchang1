...
/**
 * original_data_adv_targets_report
 * @author Administrator
 * @date 2019-11-13 17:26:57
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@Data
@Table("original_data_adv_targets_report")
public class OriginalDataAdvTargetsReport implements Serializable {
    /**
     */
    @Id("id")
    private Long id;
