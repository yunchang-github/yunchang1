...
/**
 * original_data_adv_productads_report
 * @author Administrator
 * @date 2019-11-13 12:14:40
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@Data
@Table("original_data_adv_productads_report")
public class OriginalDataAdvProductadsReport implements Serializable {
    /**
     * 数据库自增id
     */
    @Id("id")
