...
/**
 * original_data_adv_keywords_report
 * @author Administrator
 * @date 2019-11-13 17:49:19
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@Data
@Table("original_data_adv_keywords_report")
public class OriginalDataAdvKeywordsReport implements Serializable {
    /**
     */
    @Id("id")
    private Long id;
